const socialLinks = [
  ...
  {
    name: "X", href: "#",
    icon: <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.259 5.63L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>,
  },
  {
    name: "LinkedIn", href: "#",
            ...
            <div className="flex gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.name}
                  className="w-9 h-9 border border-white/20 hover:border-[#C9A84C] text-white/40 hover:text-[#C9A84C] flex items-center justify-center transition-colors duration-200"
                >
                  {s.icon}
                </a>
              ))}
